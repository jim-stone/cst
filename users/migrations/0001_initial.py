# Generated by Django 3.1.1 on 2020-09-12 21:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('managing_person', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Person',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foreign_id', models.CharField(max_length=64, null=True)),
                ('superior', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='users.organisation')),
            ],
            bases=('users.subject',),
        ),
    ]
